...
public class DBWorker {
	...
	public ResultSet getDBData(String query)
	{
		...
		try
		{
			...
			connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/phonebook?user=root&password=qwerty123&useUnicode=true&characterEncoding=UTF-8&characterSetResults=utf8&connectionCollation=utf8_general_ci");
